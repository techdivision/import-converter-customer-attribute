...
/**
 * TechDivision\Import\Converter\Customer\Attribute\Subjects\CustomerCategoryConverterSubject
 *
 * PHP version 7
 *
...
namespace TechDivision\Import\Converter\Customer\Attribute\Subjects;
...
class ConverterSubject extends \TechDivision\Import\Converter\Subjects\ConverterSubject
{
    ...
    /**
     * Append's the passed customer type artefacts to the customer with the
     * last entity ID.
     *
     * @param string $type      The artefact type, e. g. configurable
     * @param array  $artefacts The customer type artefacts
    ...
    {
        return $this->getValue(ColumnKeys::EMAIL);
    }
}
